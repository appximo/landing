...
PAGE_CSS='''<style>
  ...
  .stage .flow{display:flex;max-width:none;margin:0}
  @media(min-width:1000px){.stage{display:block}.flow-m{display:none}}
  @media(max-width:999px){
    .hero-layout{display:flex;flex-direction:column}
    .stage{display:block;order:-1;width:100%;max-width:none;margin:0 0 1.6rem;padding:.9rem;border-radius:var(--radius-2xl)}
    .flow-m{display:none}
    .hero-copy{padding-top:0}
    html.js .flow:not(.typed) .fl-after{display:none}
  }
